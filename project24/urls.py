...
urlpatterns = [
    ...
    path('display_webpagee/',display_webpagee,name='display_webpagee'),
    path('display_access/',display_access,name='display_access'),
    path('display_update/',display_update,name='display_update'),
     path('display_wupdate/',display_wupdate,name='display_wupdate'),
    path('display_webupdate/',display_webupdate,name='display_webupdate')
]
